...
`variant-chart.xlsx`, `variant-comment.xlsx`, and `variant-table.xlsx` are
generated by system Python with openpyxl 3.1.5. They reproduce the foreign
drawing, comment-part, and package-root table-relationship layouts that ExcelJS
4.4.0 cannot reconcile. Regenerate them from the repository root:
