...
`variant-chart.xlsx` is generated by system Python with openpyxl 3.1.5. It
contains a worksheet plus a BarChart and reproduces the foreign drawing layout
that ExcelJS 4.4.0 cannot reconcile. Regenerate it from the repository root:
